...
#include "httprpc.h"
#include "key.h"
/// @maxb from zcash, instead base58.h
#ifdef ENABLE_MINING
#include "key_io.h"
#endif
#include "main.h"
...
void Shutdown()
{
    ...
    /// @maxb from us: zcash has no such logic!!
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-rpcport=<port>", strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 23202, 23212));
...
static void ZC_LoadParams(
    const CChainParams& /* chainparams */ // unused
)
{
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    */
    ...
    if (GetBoolArg("-savesproutr1cs", false)) {
        ...
        pcrypticcoinParams->saveR1CS(r1cs_path.string());
    }
